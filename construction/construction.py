...
#randomkmeans_selection(train, test, max_length, number, insturction, input_insturction, output_insturction, './data', './data/szgao/resource/pretrain/microsoft/unixcoder-base')
